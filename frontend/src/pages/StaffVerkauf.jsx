  ...
  return (
    <StaffLayout onLogout={onLogout}>
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h2 className="text-4xl font-bold text-blue-600 mb-2">Verkauf</h2>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-md border border-slate-100 overflow-hidden p-6">
              ...
              {!cameraActive ? (
                <button
                  onClick={startCamera}
                  className="w-full px-6 py-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 font-bold transition-colors active:scale-95 text-lg"
                >
                  📷 Kamera starten
                </button>
              ) : (
              ...
              {scannedParticipant && (
                <div className="mt-6 p-6 bg-gradient-to-br from-blue-50 to-cyan-50 border-2 border-blue-300 rounded-xl">
                  <p className="text-xs font-bold text-blue-600 uppercase tracking-wider">Gescannter Teilnehmer</p>
                  <p className="text-3xl font-bold text-blue-700 mt-2">TN #{scannedParticipant}</p>
                  <p className="text-sm text-slate-600 mt-1">Guthaben</p>
                  <p className="text-4xl font-bold text-blue-600 mt-1">€{participantBalance.toFixed(2)}</p>
                  <button
                    onClick={() => {
                    ...
                    className="mt-6 w-full px-4 py-2 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors text-sm"
                  >
                    Anderen scannen
                  </button>
                </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <h3 className="text-2xl font-bold text-blue-600 mt-1">Wählen Sie ein Produkt</h3>
                  </div>
                </div>
                    ...
                    <button
                      ...
                      className={`group p-4 rounded-xl transition-all transform active:scale-95 font-bold text-center border-2 ${
                        participantBalance < product.price
                          ...
                          : 'bg-gradient-to-br from-blue-400 to-blue-500 text-white border-blue-500 hover:shadow-lg hover:-translate-y-1'
                      }`}
                    >
